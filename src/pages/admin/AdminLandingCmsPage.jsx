    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-brand-muted">
            ...
            Edit homepage copy, images, and preview the outcome before publishing to the public site.
      ...
      <div className="grid gap-6 xl:grid-cols-[280px_1fr]">
        ...
        <div className="rounded-2xl border border-brand-border/60 bg-white p-5 shadow-sm sm:p-6">
          ...
          <p className="mb-4 text-sm font-bold text-brand-ink">Edit {LANDING_CMS_SECTIONS.find((s) => s.id === activeSection)?.label}</p>
            ...
            {Object.entries(sectionFields).map(([key, value]) =>
              ...
              isCmsImageField(key) ? (
                ...
                <Field
                  ...
                  multiline={["subtitle", "summary", "extended", "whatsappMessage"].includes(key)}
