...
export const immersionExperiences = [
  "Walking through local markets and villages",
  "Engaging with artisans and storytellers",
  "Dancing to traditional drums at sunset",
  "Savoring cuisine prepared with centuries-old recipes",
...
export const whyChooseAfriQuest = [
  ...
  },
  {
    ...
    description:
      "Affordable, carefully designed travel packages with safety, comfort, and cultural depth at the core.",
  },
  {
  ...
  },
  {
    ...
    description:
      "A dedicated team committed to your comfort, cultural immersion, and a journey that stays with you long after you return home.",
  },
];
...
export const experienceCategories = [
  ...
  {
    title: "Community Impact Tours",
    description: "Volunteer opportunities and community engagement that leave lasting footprints.",
    icon: "🤝",
  },
];
