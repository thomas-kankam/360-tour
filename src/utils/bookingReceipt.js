...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: Georgia, "Times New Roman", serif; color: #17130E; background: #FCF8F0; padding: 32px 16px; }
    .receipt { max-width: 720px; margin: 0 auto; background: #fff; border: 1px solid #E6DBC6; border-radius: 16px; overflow: hidden; box-shadow: 0 12px 40px rgba(23,19,14,0.12); }
    .header { background: linear-gradient(135deg, #006B3F 0%, #00512F 100%); color: #fff; padding: 28px 32px; }
    ...
    .notice { background: #FFF8EB; border-left: 4px solid #FCD116; padding: 16px 20px; margin: 0; }
    .notice strong { display: block; color: #A20D1E; font-size: 14px; margin-bottom: 6px; }
    .notice p { font-size: 13px; line-height: 1.5; color: #655C4E; }
    .body { padding: 28px 32px 32px; }
    .section { margin-bottom: 24px; }
    .section h2 { font-size: 11px; text-transform: uppercase; letter-spacing: 0.14em; color: #CE1126; margin-bottom: 12px; font-family: Arial, sans-serif; }
    table { width: 100%; border-collapse: collapse; font-size: 13px; }
    table.info td { padding: 8px 0; vertical-align: top; border-bottom: 1px solid #F0EBE0; }
    table.info td:first-child { width: 38%; color: #655C4E; font-family: Arial, sans-serif; }
    table.info td:last-child { font-weight: 600; }
    table.travelers { font-family: Arial, sans-serif; font-size: 12px; }
    table.travelers th { text-align: left; padding: 8px 10px; background: #FCF8F0; color: #655C4E; font-size: 10px; text-transform: uppercase; letter-spacing: 0.08em; }
    table.travelers td { padding: 10px; border-bottom: 1px solid #F0EBE0; vertical-align: top; }
    .status { display: inline-block; background: #EAF2EE; color: #006B3F; font-family: Arial, sans-serif; font-size: 12px; font-weight: 700; padding: 6px 12px; border-radius: 999px; }
    .footer { border-top: 1px solid #E6DBC6; padding: 20px 32px; background: #FAFAF8; font-family: Arial, sans-serif; font-size: 11px; color: #655C4E; line-height: 1.6; }
  ...
  <div class="receipt">
    ...
    <div class="footer">
      ...
      <p class="no-print" style="margin-top:16px;">
        <button onclick="window.print()" style="background:#006B3F;color:#fff;border:none;padding:10px 20px;border-radius:8px;font-size:13px;cursor:pointer;font-weight:600;">
          Print receipt
        </button>
      </p>
    </div>
